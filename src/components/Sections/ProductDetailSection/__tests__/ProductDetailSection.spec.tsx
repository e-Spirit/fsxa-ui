...
const foldableContentList: Record<string, any> = {
  Delivery:
    "mechanical lockcamera with integrated face recognitionwireless numpadoperation manual",
  "Installation instructions": "Fix it at the door. Ready.",
  Compatibility: "Google HomeAmazon AlexaBosch Smart Home",
};
