...
import FullWidthImageSliderSection from "./components/Sections/FullWidthImageSliderSection";
      ...
      <div class="w-full flex flex-col py-10">
        <Slider
          ...
          renderControls={params => {
            return [
              <Button
                class="absolute top-1/2 -mt-3 left-0"
                variant="tag"
                handleClick={() => params.showSlide(params.prevSlideIndex!)}
              >
                {"<"}
              </Button>,
              <Button
                class="absolute top-1/2 -mt-3 right-0"
                variant="tag"
                handleClick={() => params.showSlide(params.nextSlideIndex!)}
              >
                {">"}
              </Button>,
            ];
